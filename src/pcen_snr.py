...
def detect_activity(y, sr,
    ...
    """
    This function detect the voice activities in signal y and return the start and
    ...
    peak_threshold : float >= 0
        The threshold for find_peaks function.
        
    activity_threshold : float >= 0
        The threshold for defining the start and end of a voice activity.

    Returns
    -------
    start_times : np.ndarray, non-negative 
        The start times of voice activities detected in signal y (seconds).
        
    end_times : np.ndarray, non-negative 
    ...
    if medfilt_time_constant is None:
        medfilt_time_constant = 1
    else:
        medfilt_time_constant = medfilt_time_constant * sr
        
    median_pcen_snr = scipy.signal.medfilt(pcen_snr, kernel_size=medfilt_time_constant)
